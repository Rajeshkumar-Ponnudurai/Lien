...
import { Calculator, Calendar, Info, Globe, MapPin, Briefcase, ChevronRight, Loader2, RefreshCcw } from 'lucide-react';
...
export default function QuickRemediesScreen() {
  ...
  const { data: datesRes, isFetching: isDatesFetching } = useGetRemedyDatesQuery(
