                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-3xl font-bold text-slate-900">{
                            isFetching ? (<span className="inline-block w-6 h-3 ml-1 bg-slate-200 rounded animate-pulse"></span>) : data?.data?.total}</p>
                    </div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-3xl font-bold text-green-600">{
                            isFetching ? (<span className="inline-block w-6 h-3 ml-1 bg-slate-200 rounded animate-pulse"></span>) : data?.data?.active || 0}</p>
                    </div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-3xl font-bold text-amber-600">{
                            isFetching ? (<span className="inline-block w-6 h-3 ml-1 bg-slate-200 rounded animate-pulse"></span>) : data?.data?.inprogress || 0}</p>
                    </div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        isFetching ? (<span className="inline-block w-6 h-3 ml-1 bg-slate-200 rounded animate-pulse"></span>) : data?.data?.completed || 0}</p>
                    </div>
